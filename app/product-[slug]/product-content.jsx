...
export default function ProductPageContent({ initialProduct }) {
  const router = useRouter();
  const [selectedSize, setSelectedSize] = useState('M');
  const [mainImage, setMainImage] = useState(initialProduct?.image_url || 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=1000&auto=format&fit=crop');
  ...
  const productDescription = product.description || 'Premium performance apparel engineered for the court. Features cutting-edge moisture-wicking fabric, four-way stretch, and our signature minimalist design.';
            ...
            <div className="max-w-[1600px] mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold mb-8">${parseFloat(productPrice).toFixed(2)}</p>
                  ...
                  {/* Add to Cart */}
                  <button onClick={() => addToCart(product)} className="w-full py-4 bg-black text-white uppercase font-bold text-sm tracking-wider rounded hover:bg-gray-800 active:scale-95 transition-all flex items-center justify-center gap-2 mb-4">
                    <i className="ph ph-shopping-cart text-xl"></i>
