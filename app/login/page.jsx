...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setStoredMember({ id: data.id, email: data.email, name: data.name || email.split('@')[0], approved: true, wins: data.wins || 0, losses: data.losses || 0, rank: data.rank || null, neva_cash_balance: data.neva_cash_balance || 0, adminToken: data.adminToken, memberToken: data.memberToken });
